...
public class Convert {
    ...
    //将16进制转换成10进制
    public int convertHexTo10String (String bString){
    ...
    //将二进制转换成10进制
    public int convert2To10String (String bString){
        return Integer.valueOf(bString, 2);
    }
    //将二进制转换成16进制
    public String convert2ToHexString (String bString)
    {
    ...
    public String convertHexTo2String (String hexString)
    {
    ...
    //将接收到的命令每隔两个字符加上一个空格
    public String addSpace(String acceptCommand){
        String regex = "(.{2})";
